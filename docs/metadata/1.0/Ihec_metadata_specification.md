...
The same attribute may be used multiple times in a single XML record. This may be most useful, for example, for supplying CURIEs to multiple ontologies or for supplying multiple references to a single ontology such as in the case of DISEASE_ONTOLOGY_URI. For example, describing a brain primary tissue using ontology terms for ('Brodmann (1909) area 8', 'Brodmann (1909) area 9') would be:
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) obi:OBI_0002039, obi:OBI_0001853' or any of its subclasses.

__LIBRARY_STRATEGY:__ (Controlled Vocabulary) 'ATAC-Seq', 'DNase-Hypersensitivity'.

__MOLECULE_ONTOLOGY_URI__ (Ontology: SO) 'so:0000991' or any of its subclasses.
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) 'obi:OBI_0001863' or any of its subclasses.
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) 'obi:OBI_0000693' or any of its subclasses.
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) 'obi:OBI_0001861' or any of its subclasses.
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) 'obi:OBI_0000716' or any of its subclasses.
...
__EXPERIMENT_ONTOLOGY_URI__ (Ontology: OBI) 'obi:OBI_0001271' or any of its subclasses.

__LIBRARY_STRATEGY__ - (Controlled Vocabulary) 'RNA-Seq'.

__MOLECULE_ONTOLOGY_URI__ (Ontology: SO) 'so:0000234' or any of its subclasses.
